...
<p>
  <a href="https://github.com/AverageConsumer/kanto-gear/releases/tag/v2.3.3"><img src="https://img.shields.io/badge/release-v2.3.3-5c8a3c" alt="Latest release: v2.3.3"></a>
...
<p><strong><a href="https://github.com/AverageConsumer/kanto-gear/releases/tag/v2.3.3">Download Kanto Gear</a></strong> · <strong><a href="#install">Install</a></strong> · <strong><a href="https://github.com/AverageConsumer/kanto-gear/issues">Report a problem</a></strong></p>
...
| [Kanto Gear 2.3.3](https://github.com/AverageConsumer/kanto-gear/releases/tag/v2.3.3) | **Yes** | Companion UI and display modes |
| [Kanto Gear Deutsch 0.2.5](https://github.com/AverageConsumer/kanto-gear/releases/tag/v2.3.3) | No | German text for the Kanto Gear interface |
| [Kanto Gear Español (España) 0.2.5](https://github.com/AverageConsumer/kanto-gear/releases/tag/v2.3.3) | No | Spanish (Spain) text for the Kanto Gear interface |
...
1. Install the [latest official Gen1Recomp release](https://github.com/bryanthaboi/gen1recomp/releases/latest)
   for your platform.
2. Download [Kanto Gear 2.3.3](https://github.com/AverageConsumer/kanto-gear/releases/tag/v2.3.3).
