...
<p>
  <a href="https://github.com/AverageConsumer/kanto-gear/releases/tag/v2.3.2"><img src="https://img.shields.io/badge/release-v2.3.2-5c8a3c" alt="Latest release: v2.3.2"></a>
...
<p><strong><a href="https://github.com/AverageConsumer/kanto-gear/releases/tag/v2.3.2">Download Kanto Gear</a></strong> · <strong><a href="#install">Install</a></strong> · <strong><a href="https://github.com/AverageConsumer/kanto-gear/issues">Report a problem</a></strong></p>
...
Kanto Gear 2.3 works with the official Gen1Recomp 0.1.99 release or newer. No
...
| [Kanto Gear 2.3.2](https://github.com/AverageConsumer/kanto-gear/releases/tag/v2.3.2) | **Yes** | Companion UI and display modes |
| [Kanto Gear Deutsch 0.2.5](https://github.com/AverageConsumer/kanto-gear/releases/tag/v2.3.2) | No | German text for the Kanto Gear interface |
| [Kanto Gear Español (España) 0.2.5](https://github.com/AverageConsumer/kanto-gear/releases/tag/v2.3.2) | No | Spanish (Spain) text for the Kanto Gear interface |
...
1. Install the [latest official Gen1Recomp release](https://github.com/bryanthaboi/gen1recomp/releases/latest)
   for your platform.
2. Download [Kanto Gear 2.3.2](https://github.com/AverageConsumer/kanto-gear/releases/tag/v2.3.2).
...
`kanto_gear_de-0.2.5.zip` or `kanto_gear_es-0.2.5.zip` from the same release.
...
Kanto Gear 2.3 requires the official Gen1Recomp 0.1.99 release or newer. The
