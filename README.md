...
<p>
  <a href="https://github.com/AverageConsumer/kanto-gear/releases/tag/v1.8.5"><img src="https://img.shields.io/badge/release-v1.8.5-5c8a3c" alt="Latest release: v1.8.5"></a>
...
<p><strong><a href="https://github.com/AverageConsumer/kanto-gear/releases/tag/v1.8.5">Download Kanto Gear</a></strong> · <strong><a href="#install-on-android">Install on Android</a></strong> · <strong><a href="https://github.com/AverageConsumer/kanto-gear/issues">Report a problem</a></strong></p>
...
| --- | :---: | --- |
| [Gen1Recomp Android Test 0.1.81-kanto.11](https://github.com/AverageConsumer/gen1recomp/releases/tag/v0.1.81-kanto.11) | **Yes** | Android host with Gold and the dual-display bridge |
| [Kanto Gear 1.8.5](https://github.com/AverageConsumer/kanto-gear/releases/tag/v1.8.5) | **Yes** | The second-screen companion mod |
| [Kanto Gear Deutsch 0.2.2](https://github.com/AverageConsumer/kanto-gear/releases/tag/v1.8.5) | No | German text for the Kanto Gear interface |
...
1. Install the [Gen1Recomp Android Test APK](https://github.com/AverageConsumer/gen1recomp/releases/tag/v0.1.81-kanto.11).
2. Download [Kanto Gear 1.8.5](https://github.com/AverageConsumer/kanto-gear/releases/tag/v1.8.5).
...
> prompt, manually install `0.1.81-kanto.11` once. That prompt installed the
