return function(ui)
  ...
  function H:battleBagIcon(x, y)
    ...
    box("fill", x + 22, y + 1, 5, 1, colors.outline)
    box("fill", x + 20, y + 2, 9, 2, colors.outline)
    box("fill", x + 19, y + 4, 4, 8, colors.outline)
    box("fill", x + 26, y + 4, 4, 21, colors.outline)
    box("fill", x + 24, y + 23, 5, 4, colors.outline)
    box("fill", x + 21, y + 26, 5, 3, colors.outline)
    box("fill", x + 22, y + 2, 5, 1, strapLight)
    box("fill", x + 21, y + 3, 7, 1, strap)
    box("fill", x + 20, y + 4, 2, 7, strapLight)
    box("fill", x + 27, y + 5, 2, 18, strapLight)
    box("fill", x + 25, y + 23, 3, 3, strap)
    box("fill", x + 22, y + 27, 3, 1, strapLight)
    ...
    box("fill", x + 1, y + 10, 24, 5, colors.outline)
    box("fill", x, y + 14, 25, 10, colors.outline)
    box("fill", x + 1, y + 24, 24, 4, colors.outline)
    box("fill", x + 3, y + 28, 21, 2, colors.outline)
    box("fill", x + 4, y + 7, 17, 20, tan)
    box("fill", x + 3, y + 8, 18, 19, tan)
    box("fill", x + 2, y + 10, 19, 17, tan)
    box("fill", x + 1, y + 14, 20, 10, tan)
