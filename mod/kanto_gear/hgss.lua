return function(ui)
  ...
  function H:battleItemIcon(item, x, y, tint)
    ...
    elseif item.icon == "machine" then
      ...
      box("fill", x + 2, y + 4, 12, 1, colors.outline)
      box("fill", x + 1, y + 5, 14, 6, colors.outline)
      box("fill", x + 2, y + 11, 12, 1, colors.outline)
      box("fill", x + 3, y + 12, 10, 1, colors.outline)
      box("fill", x + 4, y + 13, 8, 1, colors.outline)
      box("fill", x + 6, y + 14, 4, 1, colors.outline)
      box("fill", x + 6, y + 2, 4, 1, tint)
      box("fill", x + 4, y + 3, 8, 1, tint)
      box("fill", x + 3, y + 4, 10, 1, tint)
      box("fill", x + 2, y + 5, 12, 6, tint)
      box("fill", x + 3, y + 11, 10, 1, tint)
      box("fill", x + 4, y + 12, 8, 1, tint)
      box("fill", x + 6, y + 13, 4, 1, tint)
