return function(ui)
  ...
  function H:battleRunAction(mon, selected, offsetX, offsetY)
    ...
    box("fill", 118, 155, 5, 6, colors.white)
    box("fill", 117, 156, 7, 4, colors.white)
    box("fill", 116, 163, 7, 8, colors.white)
    box("fill", 112, 163, 4, 3, colors.white)
    box("fill", 111, 165, 3, 7, colors.white)
    box("fill", 122, 164, 8, 3, colors.white)
    box("fill", 114, 170, 5, 4, colors.white)
    box("fill", 110, 173, 6, 3, colors.white)
    box("fill", 107, 175, 7, 3, colors.white)
    box("fill", 120, 170, 4, 5, colors.white)
    box("fill", 122, 174, 4, 5, colors.white)
