return function(ui)
  ...
  function H:battleBagIcon(x, y)
    ...
    box("fill", x + 18, y + 4, 4, 8, colors.outline)
    box("fill", x + 25, y + 4, 4, 21, colors.outline)
    box("fill", x + 23, y + 23, 5, 4, colors.outline)
    box("fill", x + 20, y + 26, 5, 3, colors.outline)
    box("fill", x + 21, y + 2, 5, 1, strapLight)
    box("fill", x + 20, y + 3, 7, 1, strap)
    box("fill", x + 19, y + 4, 2, 7, strapLight)
    box("fill", x + 26, y + 5, 2, 18, strapLight)
    box("fill", x + 24, y + 23, 3, 3, strap)
    box("fill", x + 21, y + 27, 3, 1, strapLight)
    ...
    box("fill", x, y + 14, 26, 10, colors.outline)
