return function(ui)
  ...
  function H:battleItemIcon(item, x, y, tint)
    ...
    elseif item.icon == "machine" then
      box("fill", x + 6, y, 4, 1, colors.outline)
      box("fill", x + 4, y + 1, 8, 1, colors.outline)
      box("fill", x + 2, y + 2, 12, 2, colors.outline)
      box("fill", x + 1, y + 4, 14, 8, colors.outline)
      box("fill", x + 2, y + 12, 12, 2, colors.outline)
      box("fill", x + 4, y + 14, 8, 1, colors.outline)
      box("fill", x + 6, y + 15, 4, 1, colors.outline)
      box("fill", x + 6, y + 1, 4, 1, tint)
      box("fill", x + 4, y + 2, 8, 1, tint)
      box("fill", x + 3, y + 3, 10, 1, tint)
      box("fill", x + 2, y + 4, 12, 8, tint)
      box("fill", x + 3, y + 12, 10, 1, tint)
      box("fill", x + 4, y + 13, 8, 1, tint)
      box("fill", x + 6, y + 14, 4, 1, tint)
