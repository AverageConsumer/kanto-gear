...
assert(count == 450, "El catálogo de traducción está incompleto")
...
for _, source in ipairs({
  ...
  "SETTINGS", "OPTIONS", "APPEARANCE", "THEME AND MOTION", "DISPLAY",
  "SCREENS AND LAYOUT", "UI MOTION", "DISPLAY MODE",
